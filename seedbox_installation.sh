...
install_bbrx_() {
	...
	wget https://raw.githubusercontent.com/race-in/dedi-components/main/BBR/BBRx/BBRx.sh && chmod +x BBRx.sh
	# Check if download fail
	if [ ! -f BBRx.sh ]; then
...
install_bbrv3_() {
	...
	return 1
	if [ $(uname -m) == "x86_64" ]; then
		wget https://raw.githubusercontent.com/race-in/dedi-components/main/BBR/BBRv3/x86_64/linux-headers-6.4.0+-amd64.deb
		if [ ! -f linux-headers-6.4.0+-amd64.deb ]; then
			fail "BBRv3 download failed"
			return 1
		fi
		wget https://raw.githubusercontent.com/race-in/dedi-components/main/BBR/BBRv3/x86_64/linux-image-6.4.0+-amd64.deb
		if [ ! -f linux-image-6.4.0+-amd64.deb ]; then
			fail "BBRv3 download failed"
			rm linux-headers-6.4.0+-amd64.deb
			return 1
		fi
		wget https://raw.githubusercontent.com/race-in/dedi-components/main/BBR/BBRv3/x86_64/linux-libc-dev_-6.4.0-amd64.deb
		...
		wget https://raw.githubusercontent.com/race-in/dedi-components/main/BBR/BBRv3/ARM64/linux-headers-6.4.0+-arm64.deb
		if [ ! -f linux-headers-6.4.0+-arm64.deb ]; then
			fail "BBRv3 download failed"
			return 1
		fi
		wget https://raw.githubusercontent.com/race-in/dedi-components/main/BBR/BBRv3/ARM64/linux-image-6.4.0+-arm64.deb
		if [ ! -f linux-image-6.4.0+-arm64.deb ]; then
			fail "BBRv3 download failed"
			rm linux-headers-6.4.0+-arm64.deb
			return 1
		fi
		wget https://raw.githubusercontent.com/race-in/dedi-components/main/BBR/BBRv3/ARM64/linux-libc-dev_-6.4.0-arm64.deb
